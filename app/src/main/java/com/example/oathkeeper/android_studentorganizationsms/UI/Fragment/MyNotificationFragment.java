...
import com.example.oathkeeper.android_studentorganizationsms.Adapter.ManageAdapter;
import com.example.oathkeeper.android_studentorganizationsms.Adapter.NotificationAdapter;
...
//        mRecyclerView.setLayoutManager(new StaggeredGridLayoutManager(2, OrientationHelper.VERTICAL));//这里用线性宫格显示 类似于瀑布流
        recyclerView.setAdapter(new NotificationAdapter(context));
        return view;
    }
